...
uint256 hashGenesisBlock("0x59dfef22c703c80136fe5cc8e56a820c5cf6f7929804774b76476d0308756217");
...
const string strMessageMagic = "MackCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // MackCoin: 1 days
static const int64 nTargetSpacing = 120; // MackCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mackcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MackCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xde7cbaf9a8a5aef396d76d8a7864df3e7de7a4635960ddae2a620644f290ef9c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "MackCoin created on 19.02.2018";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1519245097; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3287242;

        if (fTestNet)
        {
            block.nTime    = 1519071439;
            block.nNonce   = 1498306;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x84aa8b084d697a401e65c0986545197c646d73cff55c249483b8258d49e52248"));
